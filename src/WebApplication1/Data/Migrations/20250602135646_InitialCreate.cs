        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateShown = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdviceLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAdviceLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAdviceLogs_DailyAdvices_AdviceId",
                        column: x => x.AdviceId,
                        principalTable: "DailyAdvices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAdviceLogs_AdviceId",
                table: "UserAdviceLogs",
                column: "AdviceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAdviceLogs_UserId_DateShown",
                table: "UserAdviceLogs",
